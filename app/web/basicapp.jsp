        ...
        <div class="theme-container container">
            <div class="row">
                <div class="theme-div" style="width:37%">
                    <form action="BasicAppAction">
                        ...
                        <%
                            ...
                            out.println("<div class='form-group'>");
                            out.println("<select name='filter4' class='form-control'>");
                            out.println("<option value=''>- Filter 4 -</option>");
                            for (String type : types) {
                                if (filter4.equals(type)) {
                                    out.println("<option value=" + type + " selected>" + type + "</option>");
                                } else {
                                    out.println("<option value=" + type + ">" + type + "</option>");
                                }
                ...
                <div class="theme-div theme-content" style="width:60%">
                    <h4><b> Basic App Usage Time Report</b> </h4> <hr>
                    <%						
                                                ...
                                                for (HashMap<String, Breakdown> map2 : tier2) {
                                                    ...
                                                    if (demoCount > 2) {
                                                        ...
                                                        for (HashMap<String, Breakdown> map3 : tier3) {
                                                            ...
                                                            //For fourth table
                                                            if (demoCount > 3) {
                                                                String demo4 = demoArr[3];
                                                                ArrayList<HashMap<String, Breakdown>> tier4 = map3.get("breakdown").getBreakdown();
                                                                for (HashMap<String, Breakdown> map4 : tier4) {

                                                                    out.println("<tr style='color:red'><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"
                                                                            + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"
                                                                            + "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"
                                                                            + demo4 + ": " + map4.get(demo4) + " (count: " + map4.get("count") + " , " + map4.get("percent") + "%)</td><td>");

                                                                    if (demoCount == 4) {
                                                                        ArrayList<HashMap<String, Breakdown>> report4 = map4.get("breakdown").getBreakdown();
                                                                        HashMap<String, Breakdown> intenseMap = report4.get(0);
                                                                        HashMap<String, Breakdown> normalMap = report4.get(1);
                                                                        HashMap<String, Breakdown> mildMap = report4.get(2);
                                                                        out.println("intense users: " + intenseMap.get("intense-count") + " (" + intenseMap.get("intense-percent") + "%)<br>"
                                                                                + "normal users: " + normalMap.get("normal-count") + " (" + normalMap.get("normal-percent") + "%)<br>"
                                                                                + "mild users: " + mildMap.get("mild-count") + " (" + mildMap.get("mild-percent") + "%)<br>");
                                                                    }
