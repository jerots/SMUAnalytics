    ...
    public ArrayList<AppUsage> retrieveByUser(String macAdd, Date startDate, Date endDate) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                result.add(new AppUsage(timestamp, macaddress, new App(appid,appName, appCat)));
    ...
    public ArrayList<AppUsage> getAppsBySchool(String school, Date startDate, Date endDate) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                aList.add(new AppUsage(timestamp, macAdd, new App(appId, appName, appCat)));
            }
    ...
    public ArrayList<AppUsage> getStudentsByCategory(HashMap<String, String> priKMac, Date startDate, Date endDate) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                aList.add(new AppUsage(timeStamp, macAdd, new App(appId, appName, category)));
    ...
    public ArrayList<AppUsage> getUserAppsForSocial(String date, String macAdd){ 
        ...
        try {
            ...
            while (rs.next()) {
                ...
                sList.add(new AppUsage(timeStamp, macAdd, new App(appId, appName, category)));
            }
            rs.close();
            pStmt.close();
            conn.close();
